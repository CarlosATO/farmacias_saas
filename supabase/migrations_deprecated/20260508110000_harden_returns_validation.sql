-- 1. Correct logic for pharmaceutical returns validation
...
begin
    ...
    loop
        ...
        select si.*, p.is_controlled, b.batch_number, b.expiry_date
        into v_sale_item 
        ...
        -- CALCULAR DEVOLUCIONES PREVIAS PARA ESTE ITEM ESPECÍFICO
        ...
        if found then
            ...
            insert into pharmacy.inventory_batches (
                ...
                v_sale_item.expiry_date, v_requested_qty, v_requested_qty
        ...
        insert into pharmacy.inventory_movements (
            ...
            'RETURN', v_requested_qty, 'RET-' || v_return_id::text, v_user_id,
