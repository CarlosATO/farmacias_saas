...
export default function MapaLotesIndex() {
  ...
  useEffect(() => {
    ...
    const loadProducts = async () => {
      ...
      try {
        ...
        console.error('Error cargando indice de Mapa de Lotes:', error);
      } finally {
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="bg-white border border-gray-200 rounded-2xl p-6">
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div>
              <p className="text-[11px] font-black text-gray-500 uppercase tracking-widest mb-2">Inventario / Lotes</p>
              <h1 className="text-2xl font-black text-gray-900 uppercase tracking-tight">Mapa de Lotes y Vencimientos</h1>
              <p className="text-sm text-gray-500 mt-2">Selecciona un producto para inspeccionar lotes, ubicaciones y vencimientos.</p>
            </div>
